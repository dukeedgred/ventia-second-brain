...
This page tracks people and stakeholder roles relevant to the Spend Cube engagement. The Databricks walk-through added several platform and Transport data contacts who can help validate [[Transport Data Landscape]] findings.

## Databricks Walk-Through Participants

- Donguk Kang attended the walk-through, asked about Databricks access, schema drift, centralized Transport asset views, and GIS data.
- Yinlun Pan attended the walk-through and described the early Transport work as a broad gap analysis across Transport data before selecting deeper focus areas.
- Tanya Pita de Abreu attended the walk-through.
- Kale Skinner led the walkthrough as data engineering manager in Digital Services, representing the centralized data engineering and data science platform team.

## Platform And Transport Contacts
