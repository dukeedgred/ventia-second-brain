...
table-name: uvw_tvs07_nb_segmented
full-name: transport_dev.transport_sht.uvw_tvs07_nb_segmented
date-created: 2026-06-05
date-updated: 2026-06-05
tags: [transport, data-table, databricks, transport-sht, segmented-sensor-reading]
---

# Transport Table - transport_sht - uvw_tvs07_nb_segmented
...
| Related tables/reports | `transport_dev.transport_sht.utbl_tvs07_nb` |
...
FROM
  transport_dev.transport_sht.utbl_tvs07_nb
GROUP BY
  1
ORDER BY
  1
