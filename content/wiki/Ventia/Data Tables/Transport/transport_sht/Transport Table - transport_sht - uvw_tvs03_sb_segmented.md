...
table-name: uvw_tvs03_sb_segmented
full-name: transport_dev.transport_sht.uvw_tvs03_sb_segmented
date-created: 2026-06-05
date-updated: 2026-06-05
tags: [transport, data-table, databricks, transport-sht, segmented-sensor-reading]
---

# Transport Table - transport_sht - uvw_tvs03_sb_segmented
...
| Related tables/reports | `transport_dev.transport_sht.utbl_tvs03_sb` |
...
FROM
  transport_dev.transport_sht.utbl_tvs03_sb
GROUP BY
  1
ORDER BY
  1
