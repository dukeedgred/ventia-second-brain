...
source-schema: dbo
table-name: log
full-name: ext_mssql_asset_vision_ven_rms.dbo.log
date-created: 2026-06-05
date-updated: 2026-06-05
tags: [transport, source-table, databricks, asset-vision, asset-vision-ven-rms, log]
---

# Transport Source Table - asset_vision_ven_rms - log
