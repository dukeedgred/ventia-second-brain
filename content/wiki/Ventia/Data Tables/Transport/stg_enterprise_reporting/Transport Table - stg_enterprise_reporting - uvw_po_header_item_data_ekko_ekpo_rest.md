...
table-name: uvw_po_header_item_data_ekko_ekpo_rest
full-name: transport_dev.stg_enterprise_reporting.uvw_po_header_item_data_ekko_ekpo_rest
date-created: 2026-06-09
date-updated: 2026-06-09
tags: [transport, data-table, databricks, stg-enterprise-reporting]
---

# Transport Table - stg_enterprise_reporting - uvw_po_header_item_data_ekko_ekpo_rest
...
| Refresh/freshness | Created: 2025-08-15T14:08:25.558Z; Last altered: 2025-08-15T14:08:25.558Z |
...
```sql
SELECT
--(Only Capex, POs on hold and Deleted Items)
...
--AND s.EBELN = '4700891380'
and s.LOEKZ <> ""  -- excluding Deleted Items
or t.BSART = "ZCP" -- excluding Capex POs
or t.MEMORY <> ""
```
