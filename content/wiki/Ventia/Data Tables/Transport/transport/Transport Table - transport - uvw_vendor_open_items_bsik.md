...
table-name: uvw_vendor_open_items_bsik
full-name: transport_dev.transport.uvw_vendor_open_items_bsik
date-created: 2026-06-05
date-updated: 2026-06-05
tags: [transport, data-table, databricks, vendor, finance, sap]
---

# Transport Table - transport - uvw_vendor_open_items_bsik
...
| Source system | SAP |
| Related tables/reports | `staged.stg_sap_hana_cf_sap_ecc.bsik`, `transport_dev.transport.uvw_po_history_ekbe` |
...
from staged.stg_sap_hana_cf_sap_ecc.bsik s
