...
table-name: uvw_jobspowerbi
full-name: transport_dev.transport_srapc.uvw_jobspowerbi
date-created: 2026-06-09
date-updated: 2026-06-09
tags: [transport, data-table, databricks, transport-srapc]
---

# Transport Table - transport_srapc - uvw_jobspowerbi
...
| Refresh/freshness | Created: 2024-06-18T03:22:40.608Z; Last altered: 2024-07-18T20:31:02.605Z |
...
SELECT
  ...
  from_utc_timestamp(to_timestamp(j.completeddate), 'Australia/Sydney') as `Rectified Date`,
  ...
  (
    select 
	  c.comment 
    from ext_mssql_asset_vision_ven_rms.dbo.jobcomment c
    where c.JobID = j.id
    order by c.id DESC
    limit 1
  ) as `Latest Comment`,
