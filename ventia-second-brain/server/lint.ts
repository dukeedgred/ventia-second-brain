...
const AUDIT = [
  'You are running a READ-ONLY lint / health check on the "ResMed Second Brain" markdown knowledge base in the current working directory.',
...
const FIX = (today: string) =>
  [
    'You are CLEANING UP the "ResMed Second Brain" markdown knowledge base in the current working directory.',
    ...
    'repair frontmatter (ensure type, topic: ResMed, date-created, date-updated, tags; overview pages tagged "overview");',
