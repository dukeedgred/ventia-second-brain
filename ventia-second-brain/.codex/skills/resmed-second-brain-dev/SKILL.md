---
name: resmed-second-brain-dev
description: Work on the ResMed Second Brain repository. Use when modifying the React/HeroUI frontend, Express backend, markdown knowledge-base workflows, Codex-powered Ask/Ingest/Docs/Extract/Lint features, git auto-commit/sync behavior, or project documentation in this repo.
---

# ResMed Second Brain Dev

## Project Shape

This is a markdown-backed team knowledge base for the ResMed Indirect
