...
This directory is the markdown knowledge base for the ResMed Indirect
Procurement Spend Cube engagement.

## Layout

- `index.md`: catalog/map of curated pages. Consult it first.
- `wiki/ResMed/`: curated pages, Title Case filenames, one concept or entity per page.
...
- Use frontmatter on wiki pages: `type`, `topic: ResMed`, `sources`,
