...
description: Add persistent tickets to the Ventia Second Brain Tickets tab. Use when the user asks Codex to create, capture, persist, file, or add action items, tasks, follow-ups, to-dos, blockers, or tickets into the app's Tickets tab.
---
